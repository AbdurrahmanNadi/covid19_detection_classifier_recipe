# This model is from the pytorch implementation of COVID-Net
# You can find the source repo here: https://github.com/iliasprc/COVIDNet
...
if __name__ == '__main__':
    conf_file = 'conf/covid_net.yaml'
    with open(conf_file) as f:
        conf = yaml.load(f, yaml.Loader)
    mdl_conf = conf['model']['conf']
    print(mdl_conf)

    model = CovidNet(mdl_conf['type'], n_classes=2)
    model.to('cuda')
